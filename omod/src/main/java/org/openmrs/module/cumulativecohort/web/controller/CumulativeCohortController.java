...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/cumulativecohort/basicmoduleLink.form'.
 */
@Controller
@RequestMapping(value = "module/cumulativecohort/basicmoduleLink.form")
public class CumulativeCohortController{
	...
	private final String SUCCESS_FORM_VIEW = "/module/cumulativecohort/basicmoduleForm";
